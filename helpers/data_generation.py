...
Mname=[]
with open('Data/mnames.txt','r') as f:
    Mname=f.readlines()

Fname=[]
with open('Data/fnames.txt','r') as f:
    Fname=f.readlines()
...
def generate_Real_name():
    ...
    random2 = random.randint(0,len(Mname)-1)
    Name2 = Mname[random2]

    random3 = random.randint(0,len(Mname)-1)
    Name3 = Mname[random3]
...
for i in range(sample_size):
    real_names.append(generate_Real_name())
    real_names.append(generate_Real_name())
...
df_1.to_csv('Data/df_generated.csv')